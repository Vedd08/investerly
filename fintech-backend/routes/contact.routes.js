        ...
        html: `
          <div style="font-family:'Segoe UI',Arial,sans-serif;max-width:600px;margin:0 auto;background:#f9fafb;border-radius:12px;overflow:hidden;">
            ...
            <div style="background:linear-gradient(135deg,#1a2e1a,#2f6b35);padding:32px 40px;text-align:center;">
              ...
              <p style="color:rgba(255,255,255,0.7);margin:6px 0 0;font-size:13px;">Contact Form Submission</p>
            </div>
            <!-- Body -->
            <div style="padding:36px 40px;background:#ffffff;">
              <h2 style="color:#1a2e1a;font-size:18px;margin:0 0 24px;">New Contact Enquiry</h2>
              <table cellpadding="0" cellspacing="0" style="width:100%;border-collapse:collapse;">
                <tr>
                  <td style="padding:12px 16px;background:#f1f5f1;border-radius:8px 8px 0 0;font-size:13px;color:#6b7280;font-weight:600;width:140px;">NAME</td>
                  <td style="padding:12px 16px;background:#f1f5f1;border-radius:8px 8px 0 0;font-size:15px;color:#1a2e1a;font-weight:500;">${name}</td>
                </tr>
                <tr>
                  <td style="padding:12px 16px;border-top:1px solid #e5e7eb;font-size:13px;color:#6b7280;font-weight:600;">EMAIL</td>
                  <td style="padding:12px 16px;border-top:1px solid #e5e7eb;font-size:15px;"><a href="mailto:${email}" style="color:#2f6b35;text-decoration:none;">${email}</a></td>
                </tr>
                <tr>
                  <td colspan="2" style="padding:20px 16px 8px;border-top:1px solid #e5e7eb;font-size:13px;color:#6b7280;font-weight:600;">MESSAGE</td>
                </tr>
                <tr>
                  <td colspan="2" style="padding:0 16px 16px;font-size:15px;color:#374151;line-height:1.7;">${message}</td>
                </tr>
              </table>
      ...
      await sendEmail({
        ...
        html: `
          <div style="font-family:'Segoe UI',Arial,sans-serif;max-width:600px;margin:0 auto;background:#f9fafb;border-radius:12px;overflow:hidden;">
            <div style="background:linear-gradient(135deg,#1a2e1a,#2f6b35);padding:32px 40px;text-align:center;">
              <h1 style="color:#ffffff;margin:0;font-size:22px;font-weight:700;letter-spacing:1px;">INVESTERLY</h1>
              <p style="color:rgba(255,255,255,0.7);margin:6px 0 0;font-size:13px;">Your message has been received</p>
            </div>
            <div style="padding:36px 40px;background:#ffffff;">
              <p style="color:#1a2e1a;font-size:16px;margin:0 0 16px;">Hi <strong>${name}</strong>,</p>
              <p style="color:#374151;font-size:15px;line-height:1.7;margin:0 0 20px;">
                Thank you for reaching out to Investerly. We've received your message and our team will
              ...
              <div style="background:#f1f5f1;border-radius:8px;padding:20px 24px;margin-bottom:24px;">
                <p style="margin:0 0 8px;font-size:13px;color:#6b7280;font-weight:600;">YOUR MESSAGE</p>
